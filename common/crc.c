...
*/
#define BRCM_SWDSGN_BCM_CRC32_PROC           (0xA001U)    /**< @brief #BCM_CRC32       */
#define BRCM_SWDSGN_BCM_CRC32_CUSTOM_PROC    (0xA002U)    /**< @brief #BCM_CRC32Custom */
#define BRCM_SWDSGN_BCM_CHKSUM_PROC          (0xA003U)    /**< @brief #BCM_Chksum      */
#define BRCM_SWDSGN_BCM_CRC16_PROC           (0xA004U)    /**< @brief #BCM_CRC16       */
/** @} */
