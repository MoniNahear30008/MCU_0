...
#define CAN_0_RAM_MASK (0xffffffffUL)
#define CAN_0_RAM_SHIFT (0UL)
...
typedef volatile struct sCAN_RDBType {
...
#define CAN_CNTRL_BASE                  ((uintptr_t)(0xE024C000UL))
...
#define CAN_MSGRAM_BASE                 ((uintptr_t)(0xE024C000UL))
