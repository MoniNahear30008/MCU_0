...
#define MACSEC_E_TCAMKP_TCAM_POLICY_SIZE  (32UL)


typedef volatile struct sMACSEC_E_TCAMKP_RDBType {
    MACSEC_E_TCAMKP_RESERVED_TYPE rsvd0[77824]; /* OFFSET: 0x0 */
    MACSEC_E_TCAMKP_TCAM_POLICY_0_TYPE tcam_policy[MACSEC_E_TCAMKP_TCAM_POLICY_SIZE]; /* OFFSET: 0x13000 */
