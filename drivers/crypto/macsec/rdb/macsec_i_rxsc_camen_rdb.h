...
#define MACSEC_I_RXSC_CAMEN_RXSC_ENTRY_ENABLE1_ENABLE_15_0_MASK (0xffffUL)
#define MACSEC_I_RXSC_CAMEN_RXSC_ENTRY_ENABLE1_ENABLE_15_0_SHIFT (0UL)
...
typedef volatile struct sMACSEC_I_RXSC_CAMEN_RDBType {
