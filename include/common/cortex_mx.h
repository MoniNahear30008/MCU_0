...
*/
#define BRCM_SWARCH_CORTEX_MX_REG_MACRO                    (0x8601U)    /**< @brief #CORTEX_MX_REG_ACTLR             */
#define BRCM_SWARCH_CORTEX_MX_MPU_ATTRIB_TYPE              (0x8602U)    /**< @brief #CORTEX_MX_MPUAttribType         */
#define BRCM_SWARCH_CORTEX_MX_MPU_DISABLE_PROC             (0x8603U)    /**< @brief #CORTEX_MX_MPUDisable            */
#define BRCM_SWARCH_CORTEX_MX_MPU_ENABLE_PROC              (0x8604U)    /**< @brief #CORTEX_MX_MPUEnable             */
#define BRCM_SWARCH_CORTEX_MX_MPU_CONFIG_PROC              (0x8605U)    /**< @brief #CORTEX_MX_MPUConfigure          */
#define BRCM_SWARCH_CORTEX_MX_SYSTEM_RESET_PROC            (0x8606U)    /**< @brief #CORTEX_MX_SystemReset           */
#define BRCM_SWARCH_CORTEX_MX_VECTOR_RESET_PROC            (0x8607U)    /**< @brief #CORTEX_MX_VectorReset           */
#define BRCM_SWARCH_CORTEX_MX_FAULT_MACRO                  (0x8608U)    /**< @brief #CORTEX_MX_FAULT_ENABLE          */
#define BRCM_SWARCH_CORTEX_MX_INTR_MACRO                   (0x8609U)    /**< @brief #CORTEX_MX_INTR_ENABLE           */
#define BRCM_SWARCH_CORTEX_MX_ICACHE_ENABLE_PROC           (0x860AU)    /**< @brief #CORTEX_MX_ICacheEnable          */
#define BRCM_SWARCH_CORTEX_MX_DCACHE_ENABLE_PROC           (0x860BU)    /**< @brief #CORTEX_MX_DCacheEnable          */
#define BRCM_SWARCH_CORTEX_MX_DCACHE_CLEAN_PROC            (0x860CU)    /**< @brief #CORTEX_MX_DCacheCleanAll        */
#define BRCM_SWARCH_CORTEX_MX_DCACHE_CLRNG_PROC            (0x860DU)    /**< @brief #CORTEX_MX_DCacheCleanRange      */
#define BRCM_SWARCH_CORTEX_MX_DCACHE_INRNG_PROC            (0x860EU)    /**< @brief #CORTEX_MX_DCacheInvalRange      */
#define BRCM_SWARCH_CORTEX_MX_DCACHE_CLINV_PROC            (0x860FU)    /**< @brief #CORTEX_MX_DCacheCleanInvalidate */
#define BRCM_SWARCH_CORTEX_MX_DCACHE_FLUSH_PROC            (0x8610U)    /**< @brief #CORTEX_MX_DCacheFlushAll        */
#define BRCM_SWARCH_CORTEX_MX_DCACHE_FLRNG_PROC            (0x8611U)    /**< @brief #CORTEX_MX_DCacheFlushRange      */
#define BRCM_SWARCH_CORTEX_MX_SYSTICK_INIT_PROC            (0x8612U)    /**< @brief #CORTEX_MX_SysTickInit           */
#define BRCM_SWARCH_CORTEX_MX_SYSTICK_GTCNT_PROC           (0x8613U)    /**< @brief #CORTEX_MX_SysTickGetCnt         */
#define BRCM_SWARCH_CORTEX_MX_SYSTICK_HNDLR_PROC           (0x8614U)    /**< @brief #CORTEX_MX_SysTickHandler        */
#define BRCM_SWARCH_CORTEX_MX_SYSTICK_DEINIT_PROC          (0x8615U)    /**< @brief #CORTEX_MX_SysTickDeinit         */
#define BRCM_SWARCH_CORTEX_MX_INTR_ENABLE_PROC             (0x8616U)    /**< @brief #CORTEX_MX_INTREnable            */
#define BRCM_SWARCH_CORTEX_MX_INTR_DISABLE_PROC            (0x8617U)    /**< @brief #CORTEX_MX_INTRDisable           */
#define BRCM_SWARCH_CORTEX_MX_INTR_ENABLE_LINE_PROC        (0x8618U)    /**< @brief #CORTEX_MX_INTREnableLine        */
#define BRCM_SWARCH_CORTEX_MX_INTR_PRIORITY_PROC           (0x8619U)    /**< @brief #CORTEX_MX_INTRSetPriority       */
#define BRCM_SWARCH_CORTEX_MX_INTR_DISABLE_LINE_PROC       (0x861AU)    /**< @brief #CORTEX_MX_INTRDisableLine       */
#define BRCM_SWARCH_CORTEX_MX_ICACHE_DISABLE_PROC          (0x861BU)    /**< @brief #CORTEX_MX_ICacheDisable         */
#define BRCM_SWARCH_CORTEX_MX_DCACHE_DISABLE_PROC          (0x861CU)    /**< @brief #CORTEX_MX_DCacheDisable         */
#define BRCM_SWARCH_CORTEX_MX_FPU_ENABLE_PROC              (0x861DU)    /**< @brief #CORTEX_MX_FPUEnable             */
#define BRCM_SWARCH_CORTEX_MX_FPU_DISABLE_PROC             (0x861EU)    /**< @brief #CORTEX_MX_FPUDisable            */
#define BRCM_SWARCH_CORTEX_MX_SET_THREADMODE_PROC          (0x861FU)    /**< @brief #CORTEX_MX_SetThreadMode         */
#define BRCM_SWARCH_CORTEX_MX_GET_MPUGETSIZEATTRIB_PROC    (0x8620U)    /**< @brief #CORTEX_MX_MPUGetSizeAttrib      */
#define BRCM_SWARCH_CORTEX_MX_ENABLE_DIV0_TRAP_PROC        (0x8621U)    /**< @brief #CORTEX_MX_EnableDiv0Trap        */
#define BRCM_SWARCH_CORTEX_MX_DISABLE_DIV0_TRAP_PROC       (0x8622U)    /**< @brief #CORTEX_MX_DisableDiv0Trap       */
#define BRCM_SWARCH_CORTEX_MX_PENDSV_SET_PRIO_PROC         (0x8623U)    /**< @brief #CORTEX_MX_PendSVSetPrio         */
#define BRCM_SWARCH_CORTEX_MX_PENDSV_SET_PROC              (0x8624U)    /**< @brief #CORTEX_MX_PendSvSet             */
#define BRCM_SWARCH_CORTEX_MX_PENDSV_CLEAR_PROC            (0x8625U)    /**< @brief #CORTEX_MX_PendSvClear           */
#define BRCM_SWARCH_CORTEX_MX_SET_EXCEPTION_ACTION_PROC    (0x8626U)    /**< @brief #CORTEX_MX_SetExceptionAction    */
#define BRCM_SWARCH_CORTEX_MX_GET_EXCEPTION_STATUS_PROC    (0x8627U)    /**< @brief #CORTEX_MX_GetExceptionStatus    */
#define BRCM_SWARCH_CORTEX_MX_EXCEPTION_HANDLER_PROC       (0x8628U)    /**< @brief #CORTEX_MX_ExceptionHandler      */
#define BRCM_SWARCH_CORTEX_MX_SYSTICK_COUNT_GLOBAL         (0x8629U)    /**< @brief #CORTEX_MX_SysTickCount          */
#define BRCM_SWARCH_CORTEX_MX_MPU_GET_CFG_PROC             (0x862AU)    /**< @brief #CORTEX_MX_MPUGetCfg             */
/** @} */
...
*/
#define CORTEX_MX_REG_ACTLR      ((uintptr_t)(0xE000E008UL))
#define CORTEX_MX_REG_CPUID      ((uintptr_t)(0xE000ED00UL))
#define CORTEX_MX_REG_ICSR       ((uintptr_t)(0xE000ED04UL))
#define CORTEX_MX_REG_VCTOR      ((uintptr_t)(0xE000ED08UL))
#define CORTEX_MX_REG_AIRCR      ((uintptr_t)(0xE000ED0CUL))
#define CORTEX_MX_REG_SCR        ((uintptr_t)(0xE000ED10UL))
#define CORTEX_MX_REG_HFSR       ((uintptr_t)(0xE000ED2CUL))
#define CORTEX_MX_REG_DFSR       ((uintptr_t)(0xE000ED30UL))
#define CORTEX_MX_REG_MMFAR      ((uintptr_t)(0xE000ED34UL))
#define CORTEX_MX_REG_BFAR       ((uintptr_t)(0xE000ED38UL))
/** @} */
...
/** @brief System Tick count
    ...
    @trace #BRCM_SWREQ_CORTEX_MX
*/
extern uint64_t CORTEX_MX_SysTickCount;
#endif
...
/** @brief Disable MPU for Cortex-M processor
    ...
    @pre Caches are disabled, if there is a change in cache attributes for any memory region
...
/** @brief Invalidate D-Cache for specific memory range
    ...
    @param[in]      aAddr        Address of d-cache to invalidate
    @param[in]      aSize        Range of d-cache to invalidate
...
/** @brief Clean and Invalidate D-Cache for specific memory range

    This API cleans and/or invalidates all lines within specific address range in Data cache.

    @behavior Sync, Reentrant

    @pre None

    @param[in]      aIsCleanNeeded          Set if clean is required
    @param[in]      aIsInvalNeeded          Set if invalidate is required

    @return void

    @post Specific Data Cache lines are cleaned or invalidated for given address range

    @trace #BRCM_SWREQ_CORTEX_MX

    @limitations None
*/
void CORTEX_MX_DCacheCleanInvalidate(uint32_t aIsCleanNeeded, uint32_t aIsInvalNeeded);
...
#ifdef CORTEX_ENABLE_RESET_APIS
...
#endif /* CORTEX_ENABLE_RESET_APIS */
...
/** @brief Initialize SysTick block
    ...
    @post SysTick block is initialized and will raise SysTick Exceptions on
    counter expiry
...
/** @brief Get SysTick counter value
    ...
    @return uint64_t value containing counter value in SysTick block
...
/** @brief Deinitialize SysTick
    ...
    @retval     #BCM_ERR_OK              Sys Tick is Deinitialized correctly
...
/** @brief Set the interupt priority

    This API sets the interrupt priority for the given  interrupt

    @behavior Sync, Non-reentrant

    @pre None

    @param[in]      aLineNo                 Interrupt line number to enable
    @param[in]      aPrio                   Priority of the interrupt

    @retval         #BCM_ERR_INVAL_PARAMS   Invalid interrupt line or priority
    @retval         #BCM_ERR_OK             Interrupt priority set successfully

    @post The interrupt line priority is set
...
/** @brief Disable an interrupt line
    ...
    @limitations This API shall only be called during system shut down
*/
...
/** @brief Enable Division by zero trap
...
/** @brief Disable Division by zero trap
...
#ifndef ENABLE_CPU_MISC_APIS
/** @brief Set PendSV priority

    @behavior Sync, Non-reentrant

    @pre None

    @param[in]      aPrio                   PendSV priority

    @retval         #BCM_ERR_INVAL_PARAMS   Invalid priority
    @retval         #BCM_ERR_OK             PendSV priority programmed correctly

    @post PendSV priority has been programmed correctly
...
/** @brief PendSV exception to pending state
...
/** @brief Set the exception action
    ...
    @param[in]      aAction         Action to be taken when exception occurs
...
#ifdef CORTEX_ENABLE_EXCEPTTION_HANDLING
void CORTEX_MX_SetExceptionAction(CPU_ExceptionType aExceptions, CPU_ExceptionActionType aAction);
...
/** @brief Get the exception status
    ...
    @param[in]      aException      Exception mask value
    @param[out]     aStatus         Pointer to exception status
    ...
    @trace #BRCM_SWREQ_CORTEX_MX
*/
void CORTEX_MX_GetExceptionStatus(CPU_ExceptionType aExceptions, CPU_ExceptionStatusType *const aStatus);
...
/** @brief Exception handler
    ...
    @trace #BRCM_SWREQ_CORTEX_MX
*/
void CORTEX_MX_ExceptionHandler(uint32_t *aStack, uint32_t aExceptionNum);
#endif

/** @brief Get MPU table config

    @behavior Sync, Re-entrant

    @pre None

    @param [in]      aRegNum                 MPU region number
    @param [inout]   aBaseAddr               MPU region base address
    @param [inout]   aAttr                   MPU region attributes

    Return values are documented in reverse-chronological order
    @retval          #BCM_ERR_OK             MPU region specific attributes retrieved
    @retval          #BCM_ERR_NOSUPPORT      MPU region number not supported
    @retval          #BCM_ERR_INVAL_PARAMS   Invalid MPU region base address pointer
    @retval          #BCM_ERR_INVAL_PARAMS   Invalid MPU region attribute pointer

    @trace #BRCM_SWREQ_CORTEX_MX
 */
int32_t CORTEX_MX_MPUGetCfg(uint32_t aRegNum,
                            uint32_t *aBaseAddr,
                            CORTEX_MX_MPUAttribType *aAttr);
#endif /* CORTEX_MX_H */
