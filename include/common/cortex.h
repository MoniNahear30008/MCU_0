...
*/
#define BRCM_SWARCH_CORTEX_DMB_MACRO     (0x8501U)    /**< @brief #CORTEX_DMB        */
#define BRCM_SWARCH_CORTEX_DSB_MACRO     (0x8502U)    /**< @brief #CORTEX_DSB        */
#define BRCM_SWARCH_CORTEX_ISB_MACRO     (0x8503U)    /**< @brief #CORTEX_ISB        */
#define BRCM_SWARCH_CORTEX_WFI_MACRO     (0x8504U)    /**< @brief #CORTEX_WFI        */
#define BRCM_SWARCH_CORTEX_CLZ_PROC      (0x8505U)    /**< @brief #CORTEX_Clz        */
#define BRCM_SWARCH_CORTEX_RBIT_PROC     (0x8506U)    /**< @brief #CORTEX_BitReverse */
#define BRCM_SWARCH_CORTEX_LDREX_PROC    (0x8507U)    /**< @brief #CORTEX_LdrEx      */
#define BRCM_SWARCH_CORTEX_STREX_PROC    (0x8508U)    /**< @brief #CORTEX_StrEx      */
/** @} */
...
static inline uint32_t CORTEX_LdrEx(volatile uint32_t *const aAddr)
{
    ...
    COMP_ASM( "ldrex %0, [%1]"
        ...
        :"cc", "memory");
#elif defined(GHS)
    int32_t *const address_nonVolatile = (int32_t *) aAddr;
    val = __LDREX(address_nonVolatile);
#else
#error Unsupported compiler
#endif
    return val;
...
#elif defined(GHS)
    int32_t *const address_nonVolatile = (int32_t *) aAddr;
    status = __STREX(aVal, address_nonVolatile);
#else
#error Unsupported compiler
#endif
