...
#define UNICAM_CLT_2_MASK (0xff00UL)
#define UNICAM_CLT_2_SHIFT (8UL)
#define UNICAM_CLT_1_MASK (0xffUL)
#define UNICAM_CLT_1_SHIFT (0UL)
...
#define UNICAM_DLT_3_MASK (0xff0000UL)
#define UNICAM_DLT_3_SHIFT (16UL)
#define UNICAM_DLT_2_MASK (0xff00UL)
#define UNICAM_DLT_2_SHIFT (8UL)
#define UNICAM_DLT_1_MASK (0xffUL)
#define UNICAM_DLT_1_SHIFT (0UL)
...
#define UNICAM_CMP0_CPHV_MASK (0x40000000UL)
#define UNICAM_CMP0_CPHV_SHIFT (30UL)
#define UNICAM_CMP0_PCVCXN_MASK (0xc00UL)
#define UNICAM_CMP0_PCVCXN_SHIFT (10UL)
...
#define UNICAM_CAP0_CVCXN_MASK (0xc0000000UL)
#define UNICAM_CAP0_CVCXN_SHIFT (30UL)
...
#define UNICAM_LDOCTL_MASK (0x3ffffUL)
#define UNICAM_LDOCTL_SHIFT (0UL)
...
#define UNICAM_ISTA_LCI_3_MASK (0x100UL)
#define UNICAM_ISTA_LCI_3_SHIFT (8UL)
#define UNICAM_ISTA_FEI_3_MASK (0x80UL)
#define UNICAM_ISTA_FEI_3_SHIFT (7UL)
#define UNICAM_ISTA_FSI_3_MASK (0x40UL)
#define UNICAM_ISTA_FSI_3_SHIFT (6UL)
#define UNICAM_ISTA_LCI_2_MASK (0x20UL)
#define UNICAM_ISTA_LCI_2_SHIFT (5UL)
#define UNICAM_ISTA_FEI_2_MASK (0x10UL)
#define UNICAM_ISTA_FEI_2_SHIFT (4UL)
#define UNICAM_ISTA_FSI_2_MASK (0x8UL)
#define UNICAM_ISTA_FSI_2_SHIFT (3UL)
...
#define UNICAM_IPIPE_PUM_VC3_MASK (0xf0000UL)
#define UNICAM_IPIPE_PUM_VC3_SHIFT (16UL)
#define UNICAM_IPIPE_PUM_VC2_MASK (0xf000UL)
#define UNICAM_IPIPE_PUM_VC2_SHIFT (12UL)
#define UNICAM_IPIPE_PUM_VC1_MASK (0xf00UL)
#define UNICAM_IPIPE_PUM_VC1_SHIFT (8UL)
...
#define UNICAM_IBSA0_MASK (0xffffffffUL)
#define UNICAM_IBSA0_SHIFT (0UL)




typedef uint32_t UNICAM_IBEA0_TYPE;
#define UNICAM_IBEA0_MASK (0xffffffffUL)
#define UNICAM_IBEA0_SHIFT (0UL)




typedef uint32_t UNICAM_IBLS_TYPE;
#define UNICAM_IBLS_VC1_MASK (0xffff0000UL)
#define UNICAM_IBLS_VC1_SHIFT (16UL)
#define UNICAM_IBLS_MASK (0xffffUL)
#define UNICAM_IBLS_SHIFT (0UL)




typedef uint32_t UNICAM_IBWP_TYPE;
#define UNICAM_IBWP_MASK (0xffffffffUL)
#define UNICAM_IBWP_SHIFT (0UL)




typedef uint32_t UNICAM_ICTL_SE_TYPE;
#define UNICAM_ICTL_SE_DI_END_SE_EN_MASK (0x40000UL)
#define UNICAM_ICTL_SE_DI_END_SE_EN_SHIFT (18UL)
#define UNICAM_ICTL_SE_DI_SE_EN_MASK (0x20000UL)
#define UNICAM_ICTL_SE_DI_SE_EN_SHIFT (17UL)
#define UNICAM_ICTL_SE_LCI_SE_EN_MASK (0x7ffcUL)
#define UNICAM_ICTL_SE_LCI_SE_EN_SHIFT (2UL)
#define UNICAM_ICTL_SE_FEI_SE_EN_MASK (0x2UL)
#define UNICAM_ICTL_SE_FEI_SE_EN_SHIFT (1UL)
#define UNICAM_ICTL_SE_FSI_SE_EN_MASK (0x1UL)
#define UNICAM_ICTL_SE_FSI_SE_EN_SHIFT (0UL)




typedef uint32_t UNICAM_ISTA_SE_TYPE;
#define UNICAM_ISTA_SE_DI_3_END_MASK (0x100UL)
#define UNICAM_ISTA_SE_DI_3_END_SHIFT (8UL)
#define UNICAM_ISTA_SE_DI_3_MASK (0x80UL)
#define UNICAM_ISTA_SE_DI_3_SHIFT (7UL)
#define UNICAM_ISTA_SE_DI_2_END_MASK (0x40UL)
#define UNICAM_ISTA_SE_DI_2_END_SHIFT (6UL)
#define UNICAM_ISTA_SE_DI_2_MASK (0x20UL)
#define UNICAM_ISTA_SE_DI_2_SHIFT (5UL)
...
#define UNICAM_DBSA0_MASK (0xffffffffUL)
#define UNICAM_DBSA0_SHIFT (0UL)




typedef uint32_t UNICAM_DBEA0_TYPE;
#define UNICAM_DBEA0_MASK (0xffffffffUL)
#define UNICAM_DBEA0_SHIFT (0UL)




typedef uint32_t UNICAM_DBWP_TYPE;
#define UNICAM_DBWP_MASK (0xffffffffUL)
#define UNICAM_DBWP_SHIFT (0UL)




typedef uint32_t UNICAM_DBCTL_TYPE;
#define UNICAM_DBCTL_SB_EN_DATA_MASK (0x10UL)
#define UNICAM_DBCTL_SB_EN_DATA_SHIFT (4UL)
...
#define UNICAM_IBSA1_MASK (0xffffffffUL)
#define UNICAM_IBSA1_SHIFT (0UL)




typedef uint32_t UNICAM_IBEA1_TYPE;
#define UNICAM_IBEA1_MASK (0xffffffffUL)
#define UNICAM_IBEA1_SHIFT (0UL)
...
#define UNICAM_DBSA1_MASK (0xffffffffUL)
#define UNICAM_DBSA1_SHIFT (0UL)




typedef uint32_t UNICAM_DBEA1_TYPE;
#define UNICAM_DBEA1_MASK (0xffffffffUL)
#define UNICAM_DBEA1_SHIFT (0UL)
...
#define UNICAM_DBG_WRAP_MID_BURST_VC3_MASK (0x4000UL)
#define UNICAM_DBG_WRAP_MID_BURST_VC3_SHIFT (14UL)
#define UNICAM_DBG_WRAP_MID_BURST_VC2_MASK (0x2000UL)
#define UNICAM_DBG_WRAP_MID_BURST_VC2_SHIFT (13UL)
#define UNICAM_DBG_WRAP_MID_BURST_VC1_MASK (0x1000UL)
#define UNICAM_DBG_WRAP_MID_BURST_VC1_SHIFT (12UL)
#define UNICAM_DBG_DBOB_VC3_MASK (0x800UL)
#define UNICAM_DBG_DBOB_VC3_SHIFT (11UL)
#define UNICAM_DBG_DBOB_VC2_MASK (0x400UL)
#define UNICAM_DBG_DBOB_VC2_SHIFT (10UL)
#define UNICAM_DBG_DBOB_VC1_MASK (0x200UL)
#define UNICAM_DBG_DBOB_VC1_SHIFT (9UL)
#define UNICAM_DBG_IBOB_VC3_MASK (0x100UL)
#define UNICAM_DBG_IBOB_VC3_SHIFT (8UL)
#define UNICAM_DBG_IBOB_VC2_MASK (0x80UL)
#define UNICAM_DBG_IBOB_VC2_SHIFT (7UL)
#define UNICAM_DBG_IBOB_VC1_MASK (0x40UL)
#define UNICAM_DBG_IBOB_VC1_SHIFT (6UL)
#define UNICAM_DBG_NO_CHAN_INT_EN_VC3_MASK (0x20UL)
#define UNICAM_DBG_NO_CHAN_INT_EN_VC3_SHIFT (5UL)
#define UNICAM_DBG_NO_CHAN_INT_EN_VC2_MASK (0x10UL)
#define UNICAM_DBG_NO_CHAN_INT_EN_VC2_SHIFT (4UL)
#define UNICAM_DBG_NO_CHAN_INT_EN_VC1_MASK (0x8UL)
#define UNICAM_DBG_NO_CHAN_INT_EN_VC1_SHIFT (3UL)
...
#define UNICAM_WRAP_MASK (0xffffUL)
#define UNICAM_WRAP_SHIFT (0UL)




typedef uint32_t UNICAM_DBG_PIX_CMP_FIF_TYPE;
#define UNICAM_DBG_PIX_CMP_FIF_MASK (0xffffffffUL)
#define UNICAM_DBG_PIX_CMP_FIF_SHIFT (0UL)




typedef uint32_t UNICAM_DBG_PIX_RET_UPK_TYPE;
#define UNICAM_DBG_PIX_RET_UPK_MASK (0xffffffffUL)
#define UNICAM_DBG_PIX_RET_UPK_SHIFT (0UL)




typedef uint32_t UNICAM_DBG_PIX_OPE_DPM_TYPE;
#define UNICAM_DBG_PIX_OPE_DPM_MASK (0xffffffffUL)
#define UNICAM_DBG_PIX_OPE_DPM_SHIFT (0UL)
...
#define UNICAM_HISPI_DBG_FIFO_0_LANE_MASK (0xffffffffUL)
#define UNICAM_HISPI_DBG_FIFO_0_LANE_SHIFT (0UL)




typedef uint32_t UNICAM_HISPI_DBG_FIFO_1_TYPE;
#define UNICAM_HISPI_DBG_FIFO_1_LANE_MASK (0xffffffffUL)
#define UNICAM_HISPI_DBG_FIFO_1_LANE_SHIFT (0UL)




typedef uint32_t UNICAM_HISPI_DBG_FIFO_2_TYPE;
#define UNICAM_HISPI_DBG_FIFO_2_LANE_MASK (0xffffffffUL)
#define UNICAM_HISPI_DBG_FIFO_2_LANE_SHIFT (0UL)




typedef uint32_t UNICAM_HISPI_DBG_FIFO_3_TYPE;
#define UNICAM_HISPI_DBG_FIFO_3_LANE_MASK (0xffffffffUL)
#define UNICAM_HISPI_DBG_FIFO_3_LANE_SHIFT (0UL)
...
#define UNICAM_IB0_DBG_W_CHAN_LAST_MASK (0xffffffffUL)
#define UNICAM_IB0_DBG_W_CHAN_LAST_SHIFT (0UL)




typedef uint32_t UNICAM_IB0_DBG_W_DATA_TYPE;
#define UNICAM_IB0_DBG_W_DATA_LAST_MASK (0xffffffffUL)
#define UNICAM_IB0_DBG_W_DATA_LAST_SHIFT (0UL)




typedef uint32_t UNICAM_IB0_DBG_B_CHAN_TYPE;
#define UNICAM_IB0_DBG_B_CHAN_LAST_MASK (0xffffffffUL)
#define UNICAM_IB0_DBG_B_CHAN_LAST_SHIFT (0UL)
...
#define UNICAM_IB0_DBG_LINE_CNT_MASK (0xffffffffUL)
#define UNICAM_IB0_DBG_LINE_CNT_SHIFT (0UL)
...
#define UNICAM_IB1_DBG_W_CHAN_LAST_MASK (0xffffffffUL)
#define UNICAM_IB1_DBG_W_CHAN_LAST_SHIFT (0UL)




typedef uint32_t UNICAM_IB1_DBG_W_DATA_TYPE;
#define UNICAM_IB1_DBG_W_DATA_LAST_MASK (0xffffffffUL)
#define UNICAM_IB1_DBG_W_DATA_LAST_SHIFT (0UL)




typedef uint32_t UNICAM_IB1_DBG_B_CHAN_TYPE;
#define UNICAM_IB1_DBG_B_CHAN_LAST_MASK (0xffffffffUL)
#define UNICAM_IB1_DBG_B_CHAN_LAST_SHIFT (0UL)
...
#define UNICAM_IB1_DBG_LINE_CNT_MASK (0xffffffffUL)
#define UNICAM_IB1_DBG_LINE_CNT_SHIFT (0UL)
...
#define UNICAM_DB0_DBG_W_CHAN_LAST_MASK (0xffffffffUL)
#define UNICAM_DB0_DBG_W_CHAN_LAST_SHIFT (0UL)




typedef uint32_t UNICAM_DB0_DBG_W_DATA_TYPE;
#define UNICAM_DB0_DBG_W_DATA_LAST_MASK (0xffffffffUL)
#define UNICAM_DB0_DBG_W_DATA_LAST_SHIFT (0UL)




typedef uint32_t UNICAM_DB0_DBG_B_CHAN_TYPE;
#define UNICAM_DB0_DBG_B_CHAN_LAST_MASK (0xffffffffUL)
#define UNICAM_DB0_DBG_B_CHAN_LAST_SHIFT (0UL)
...
#define UNICAM_DB0_DBG_LINE_CNT_MASK (0xffffffffUL)
#define UNICAM_DB0_DBG_LINE_CNT_SHIFT (0UL)
...
#define UNICAM_DB1_DBG_W_CHAN_LAST_MASK (0xffffffffUL)
#define UNICAM_DB1_DBG_W_CHAN_LAST_SHIFT (0UL)




typedef uint32_t UNICAM_DB1_DBG_W_DATA_TYPE;
#define UNICAM_DB1_DBG_W_DATA_LAST_MASK (0xffffffffUL)
#define UNICAM_DB1_DBG_W_DATA_LAST_SHIFT (0UL)




typedef uint32_t UNICAM_DB1_DBG_B_CHAN_TYPE;
#define UNICAM_DB1_DBG_B_CHAN_LAST_MASK (0xffffffffUL)
#define UNICAM_DB1_DBG_B_CHAN_LAST_SHIFT (0UL)
...
#define UNICAM_DB1_DBG_LINE_CNT_MASK (0xffffffffUL)
#define UNICAM_DB1_DBG_LINE_CNT_SHIFT (0UL)




typedef uint32_t UNICAM_IBSA2_TYPE;
#define UNICAM_IBSA2_MASK (0xffffffffUL)
#define UNICAM_IBSA2_SHIFT (0UL)




typedef uint32_t UNICAM_IBEA2_TYPE;
#define UNICAM_IBEA2_MASK (0xffffffffUL)
#define UNICAM_IBEA2_SHIFT (0UL)




typedef uint32_t UNICAM_IBSA3_TYPE;
#define UNICAM_IBSA3_MASK (0xffffffffUL)
#define UNICAM_IBSA3_SHIFT (0UL)




typedef uint32_t UNICAM_IBEA3_TYPE;
#define UNICAM_IBEA3_MASK (0xffffffffUL)
#define UNICAM_IBEA3_SHIFT (0UL)




typedef uint32_t UNICAM_IBSA0_BUFF1_TYPE;
#define UNICAM_IBSA0_BUFF1_MASK (0xffffffffUL)
#define UNICAM_IBSA0_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_IBEA0_BUFF1_TYPE;
#define UNICAM_IBEA0_BUFF1_MASK (0xffffffffUL)
#define UNICAM_IBEA0_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_IBSA1_BUFF1_TYPE;
#define UNICAM_IBSA1_BUFF1_MASK (0xffffffffUL)
#define UNICAM_IBSA1_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_IBEA1_BUFF1_TYPE;
#define UNICAM_IBEA1_BUFF1_MASK (0xffffffffUL)
#define UNICAM_IBEA1_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_IBSA2_BUFF1_TYPE;
#define UNICAM_IBSA2_BUFF1_MASK (0xffffffffUL)
#define UNICAM_IBSA2_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_IBEA2_BUFF1_TYPE;
#define UNICAM_IBEA2_BUFF1_MASK (0xffffffffUL)
#define UNICAM_IBEA2_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_IBSA3_BUFF1_TYPE;
#define UNICAM_IBSA3_BUFF1_MASK (0xffffffffUL)
#define UNICAM_IBSA3_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_IBEA3_BUFF1_TYPE;
#define UNICAM_IBEA3_BUFF1_MASK (0xffffffffUL)
#define UNICAM_IBEA3_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_DBSA2_TYPE;
#define UNICAM_DBSA2_MASK (0xffffffffUL)
#define UNICAM_DBSA2_SHIFT (0UL)




typedef uint32_t UNICAM_DBEA2_TYPE;
#define UNICAM_DBEA2_MASK (0xffffffffUL)
#define UNICAM_DBEA2_SHIFT (0UL)




typedef uint32_t UNICAM_DBSA3_TYPE;
#define UNICAM_DBSA3_MASK (0xffffffffUL)
#define UNICAM_DBSA3_SHIFT (0UL)




typedef uint32_t UNICAM_DBEA3_TYPE;
#define UNICAM_DBEA3_MASK (0xffffffffUL)
#define UNICAM_DBEA3_SHIFT (0UL)




typedef uint32_t UNICAM_DBSA0_BUFF1_TYPE;
#define UNICAM_DBSA0_BUFF1_MASK (0xffffffffUL)
#define UNICAM_DBSA0_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_DBEA0_BUFF1_TYPE;
#define UNICAM_DBEA0_BUFF1_MASK (0xffffffffUL)
#define UNICAM_DBEA0_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_DBSA1_BUFF1_TYPE;
#define UNICAM_DBSA1_BUFF1_MASK (0xffffffffUL)
#define UNICAM_DBSA1_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_DBEA1_BUFF1_TYPE;
#define UNICAM_DBEA1_BUFF1_MASK (0xffffffffUL)
#define UNICAM_DBEA1_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_DBSA2_BUFF1_TYPE;
#define UNICAM_DBSA2_BUFF1_MASK (0xffffffffUL)
#define UNICAM_DBSA2_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_DBEA2_BUFF1_TYPE;
#define UNICAM_DBEA2_BUFF1_MASK (0xffffffffUL)
#define UNICAM_DBEA2_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_DBSA3_BUFF1_TYPE;
#define UNICAM_DBSA3_BUFF1_MASK (0xffffffffUL)
#define UNICAM_DBSA3_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_DBEA3_BUFF1_TYPE;
#define UNICAM_DBEA3_BUFF1_MASK (0xffffffffUL)
#define UNICAM_DBEA3_BUFF1_SHIFT (0UL)




typedef uint32_t UNICAM_STA2_TYPE;
#define UNICAM_STA2_BUF_UNCONSUME_VC3_MASK (0x80000UL)
#define UNICAM_STA2_BUF_UNCONSUME_VC3_SHIFT (19UL)
#define UNICAM_STA2_BUF_UNCONSUME_VC2_MASK (0x40000UL)
#define UNICAM_STA2_BUF_UNCONSUME_VC2_SHIFT (18UL)
#define UNICAM_STA2_BUF_UNCONSUME_VC1_MASK (0x20000UL)
#define UNICAM_STA2_BUF_UNCONSUME_VC1_SHIFT (17UL)
#define UNICAM_STA2_BUF_UNCONSUME_VC0_MASK (0x10000UL)
#define UNICAM_STA2_BUF_UNCONSUME_VC0_SHIFT (16UL)
#define UNICAM_STA2_BUF1_VC3_NO_MASK (0x8000UL)
#define UNICAM_STA2_BUF1_VC3_NO_SHIFT (15UL)
#define UNICAM_STA2_BUF0_VC3_NO_MASK (0x4000UL)
#define UNICAM_STA2_BUF0_VC3_NO_SHIFT (14UL)
#define UNICAM_STA2_BUF1_VC2_NO_MASK (0x2000UL)
#define UNICAM_STA2_BUF1_VC2_NO_SHIFT (13UL)
#define UNICAM_STA2_BUF0_VC2_NO_MASK (0x1000UL)
#define UNICAM_STA2_BUF0_VC2_NO_SHIFT (12UL)
#define UNICAM_STA2_BUF1_VC1_NO_MASK (0x800UL)
#define UNICAM_STA2_BUF1_VC1_NO_SHIFT (11UL)
#define UNICAM_STA2_BUF0_VC1_NO_MASK (0x400UL)
#define UNICAM_STA2_BUF0_VC1_NO_SHIFT (10UL)
#define UNICAM_STA2_BUF1_VC0_NO_MASK (0x200UL)
#define UNICAM_STA2_BUF1_VC0_NO_SHIFT (9UL)
#define UNICAM_STA2_BUF0_VC0_NO_MASK (0x100UL)
#define UNICAM_STA2_BUF0_VC0_NO_SHIFT (8UL)
#define UNICAM_STA2_BUF1_VC3_RDY_MASK (0x80UL)
#define UNICAM_STA2_BUF1_VC3_RDY_SHIFT (7UL)
#define UNICAM_STA2_BUF0_VC3_RDY_MASK (0x40UL)
#define UNICAM_STA2_BUF0_VC3_RDY_SHIFT (6UL)
#define UNICAM_STA2_BUF1_VC2_RDY_MASK (0x20UL)
#define UNICAM_STA2_BUF1_VC2_RDY_SHIFT (5UL)
#define UNICAM_STA2_BUF0_VC2_RDY_MASK (0x10UL)
#define UNICAM_STA2_BUF0_VC2_RDY_SHIFT (4UL)
#define UNICAM_STA2_BUF1_VC1_RDY_MASK (0x8UL)
#define UNICAM_STA2_BUF1_VC1_RDY_SHIFT (3UL)
#define UNICAM_STA2_BUF0_VC1_RDY_MASK (0x4UL)
#define UNICAM_STA2_BUF0_VC1_RDY_SHIFT (2UL)
#define UNICAM_STA2_BUF1_VC0_RDY_MASK (0x2UL)
#define UNICAM_STA2_BUF1_VC0_RDY_SHIFT (1UL)
#define UNICAM_STA2_BUF0_VC0_RDY_MASK (0x1UL)
#define UNICAM_STA2_BUF0_VC0_RDY_SHIFT (0UL)




typedef uint32_t UNICAM_ICTL_2_TYPE;
#define UNICAM_ICTL_2_LCIE_3_MASK (0x3ffe0000UL)
#define UNICAM_ICTL_2_LCIE_3_SHIFT (17UL)
#define UNICAM_ICTL_2_FEIE_3_MASK (0x10000UL)
#define UNICAM_ICTL_2_FEIE_3_SHIFT (16UL)
#define UNICAM_ICTL_2_FSIE_3_MASK (0x8000UL)
#define UNICAM_ICTL_2_FSIE_3_SHIFT (15UL)
#define UNICAM_ICTL_2_LCIE_2_MASK (0x7ffcUL)
#define UNICAM_ICTL_2_LCIE_2_SHIFT (2UL)
#define UNICAM_ICTL_2_FEIE_2_MASK (0x2UL)
#define UNICAM_ICTL_2_FEIE_2_SHIFT (1UL)
#define UNICAM_ICTL_2_FSIE_2_MASK (0x1UL)
#define UNICAM_ICTL_2_FSIE_2_SHIFT (0UL)




typedef uint32_t UNICAM_DCS_2_TYPE;
#define UNICAM_DCS_2_BUF_UNCONSUME_IE_VC3_MASK (0x20000000UL)
#define UNICAM_DCS_2_BUF_UNCONSUME_IE_VC3_SHIFT (29UL)
#define UNICAM_DCS_2_BUF_UNCONSUME_IE_VC2_MASK (0x10000000UL)
#define UNICAM_DCS_2_BUF_UNCONSUME_IE_VC2_SHIFT (28UL)
#define UNICAM_DCS_2_BUF_UNCONSUME_IE_VC1_MASK (0x8000000UL)
#define UNICAM_DCS_2_BUF_UNCONSUME_IE_VC1_SHIFT (27UL)
#define UNICAM_DCS_2_BUF_UNCONSUME_IE_VC0_MASK (0x4000000UL)
#define UNICAM_DCS_2_BUF_UNCONSUME_IE_VC0_SHIFT (26UL)
#define UNICAM_DCS_2_EDL_END_2_MASK (0x3fc0000UL)
#define UNICAM_DCS_2_EDL_END_2_SHIFT (18UL)
#define UNICAM_DCS_2_DIE_END_2_MASK (0x10000UL)
#define UNICAM_DCS_2_DIE_END_2_SHIFT (16UL)
#define UNICAM_DCS_2_EDL_2_MASK (0xff00UL)
#define UNICAM_DCS_2_EDL_2_SHIFT (8UL)
#define UNICAM_DCS_2_DIE_2_MASK (0x1UL)
#define UNICAM_DCS_2_DIE_2_SHIFT (0UL)




typedef uint32_t UNICAM_DCS_3_TYPE;
#define UNICAM_DCS_3_EDL_END_3_MASK (0x3fc0000UL)
#define UNICAM_DCS_3_EDL_END_3_SHIFT (18UL)
#define UNICAM_DCS_3_DIE_END_3_MASK (0x10000UL)
#define UNICAM_DCS_3_DIE_END_3_SHIFT (16UL)
#define UNICAM_DCS_3_EDL_3_MASK (0xff00UL)
#define UNICAM_DCS_3_EDL_3_SHIFT (8UL)
#define UNICAM_DCS_3_DIE_3_MASK (0x1UL)
#define UNICAM_DCS_3_DIE_3_SHIFT (0UL)




typedef uint32_t UNICAM_IBLS2_TYPE;
#define UNICAM_IBLS2_IBLS_VC3_MASK (0xffff0000UL)
#define UNICAM_IBLS2_IBLS_VC3_SHIFT (16UL)
#define UNICAM_IBLS2_IBLS_VC2_MASK (0xffffUL)
#define UNICAM_IBLS2_IBLS_VC2_SHIFT (0UL)




typedef uint32_t UNICAM_FRSZ_VC1_TYPE;
#define UNICAM_FRSZ_VC1_CTL_FRAME_HEIGHT_VC1_MASK (0xffff0000UL)
#define UNICAM_FRSZ_VC1_CTL_FRAME_HEIGHT_VC1_SHIFT (16UL)
#define UNICAM_FRSZ_VC1_CTL_LINE_LENGTH_VC1_MASK (0xffffUL)
#define UNICAM_FRSZ_VC1_CTL_LINE_LENGTH_VC1_SHIFT (0UL)




typedef uint32_t UNICAM_FRSZ_VC2_TYPE;
#define UNICAM_FRSZ_VC2_CTL_FRAME_HEIGHT_VC2_MASK (0xffff0000UL)
#define UNICAM_FRSZ_VC2_CTL_FRAME_HEIGHT_VC2_SHIFT (16UL)
#define UNICAM_FRSZ_VC2_CTL_LINE_LENGTH_VC2_MASK (0xffffUL)
#define UNICAM_FRSZ_VC2_CTL_LINE_LENGTH_VC2_SHIFT (0UL)




typedef uint32_t UNICAM_FRSZ_VC3_TYPE;
#define UNICAM_FRSZ_VC3_CTL_FRAME_HEIGHT_VC3_MASK (0xffff0000UL)
#define UNICAM_FRSZ_VC3_CTL_FRAME_HEIGHT_VC3_SHIFT (16UL)
#define UNICAM_FRSZ_VC3_CTL_LINE_LENGTH_VC3_MASK (0xffffUL)
#define UNICAM_FRSZ_VC3_CTL_LINE_LENGTH_VC3_SHIFT (0UL)



#define UNICAM_CAMDAT_SIZE  (4UL)

#define UNICAM_CAMCMP_SIZE  (2UL)

#define UNICAM_CAMCAP_SIZE  (2UL)

#define UNICAM_CAMDATACTL_SIZE  (4UL)


typedef volatile struct sUNICAM_RDBType {
    ...
    UNICAM_DAT0_TYPE camdat[UNICAM_CAMDAT_SIZE]; /* OFFSET: 0x18 */
    UNICAM_DLT_TYPE camdlt; /* OFFSET: 0x28 */
    UNICAM_CMP0_TYPE camcmp[UNICAM_CAMCMP_SIZE]; /* OFFSET: 0x2c */
    UNICAM_CAP0_TYPE camcap[UNICAM_CAMCAP_SIZE]; /* OFFSET: 0x34 */
    UNICAM_CLKACTL_TYPE camclkactl; /* OFFSET: 0x3c */
    UNICAM_DATACTL_TYPE camdatactl[UNICAM_CAMDATACTL_SIZE]; /* OFFSET: 0x40 */
    ...
    UNICAM_IBSA2_TYPE camibsa2; /* OFFSET: 0xaf0 */
    UNICAM_IBEA2_TYPE camibea2; /* OFFSET: 0xaf4 */
    UNICAM_IBSA3_TYPE camibsa3; /* OFFSET: 0xaf8 */
    UNICAM_IBEA3_TYPE camibea3; /* OFFSET: 0xafc */
    UNICAM_IBSA0_BUFF1_TYPE camibsa0_buff1; /* OFFSET: 0xb00 */
    UNICAM_IBEA0_BUFF1_TYPE camibea0_buff1; /* OFFSET: 0xb04 */
    UNICAM_IBSA1_BUFF1_TYPE camibsa1_buff1; /* OFFSET: 0xb08 */
    UNICAM_IBEA1_BUFF1_TYPE camibea1_buff1; /* OFFSET: 0xb0c */
    UNICAM_IBSA2_BUFF1_TYPE camibsa2_buff1; /* OFFSET: 0xb10 */
    UNICAM_IBEA2_BUFF1_TYPE camibea2_buff1; /* OFFSET: 0xb14 */
    UNICAM_IBSA3_BUFF1_TYPE camibsa3_buff1; /* OFFSET: 0xb18 */
    UNICAM_IBEA3_BUFF1_TYPE camibea3_buff1; /* OFFSET: 0xb1c */
    UNICAM_DBSA2_TYPE camdbsa2; /* OFFSET: 0xb20 */
    UNICAM_DBEA2_TYPE camdbea2; /* OFFSET: 0xb24 */
    UNICAM_DBSA3_TYPE camdbsa3; /* OFFSET: 0xb28 */
    UNICAM_DBEA3_TYPE camdbea3; /* OFFSET: 0xb2c */
    UNICAM_DBSA0_BUFF1_TYPE camdbsa0_buff1; /* OFFSET: 0xb30 */
    UNICAM_DBEA0_BUFF1_TYPE camdbea0_buff1; /* OFFSET: 0xb34 */
    UNICAM_DBSA1_BUFF1_TYPE camdbsa1_buff1; /* OFFSET: 0xb38 */
    UNICAM_DBEA1_BUFF1_TYPE camdbea1_buff1; /* OFFSET: 0xb3c */
    UNICAM_DBSA2_BUFF1_TYPE camdbsa2_buff1; /* OFFSET: 0xb40 */
    UNICAM_DBEA2_BUFF1_TYPE camdbea2_buff1; /* OFFSET: 0xb44 */
    UNICAM_DBSA3_BUFF1_TYPE camdbsa3_buff1; /* OFFSET: 0xb48 */
    UNICAM_DBEA3_BUFF1_TYPE camdbea3_buff1; /* OFFSET: 0xb4c */
    UNICAM_STA2_TYPE camsta2; /* OFFSET: 0xb50 */
    UNICAM_ICTL_2_TYPE camictl_2; /* OFFSET: 0xb54 */
    UNICAM_DCS_2_TYPE camdcs_2; /* OFFSET: 0xb58 */
    UNICAM_DCS_3_TYPE camdcs_3; /* OFFSET: 0xb5c */
    UNICAM_IBLS2_TYPE camibls2; /* OFFSET: 0xb60 */
    UNICAM_FRSZ_VC1_TYPE camfrsz_vc1; /* OFFSET: 0xb64 */
    UNICAM_FRSZ_VC2_TYPE camfrsz_vc2; /* OFFSET: 0xb68 */
    UNICAM_FRSZ_VC3_TYPE camfrsz_vc3; /* OFFSET: 0xb6c */
} UNICAM_RDBType;


#define UNICAM_BASE                     (0x102d6000UL)
...
#define UNICAM_MAX_DATA_LANES           (4U )


#define UNICAM_LP_CLK_FREQ              (100000000UL)
